...
INSERT INTO TABELA_DE_CLIENTES (CPF, NOME, ENDERECO_1, BAIRRO, CIDADE, ESTADO, CEP, DATA_DE_NASCIMENTO, IDADE, GENERO, LIMITE_DE_CREDITO, VOLUME_DE_COMPRA, PRIMEIRA_COMPRA)
VALUES ('12345678901', 'Nome do Cliente', 'Endereco 123', 'Bairro do Cliente', 'Cidade do Cliente', 'SP', '12345678', '1990-01-01', 33, 'M', 1000.00, 500.00, 1);
