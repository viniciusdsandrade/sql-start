...
-- Remove a tabela "TABELA DE VENDEDORES" se ela existir
...
INSERT INTO [TABELA DE PRODUTOS]
VALUES ('1040108', 'Light - 350 ml - Morango', 'Lata', '350ml', 'Morango', 4.56),
...
INSERT INTO [TABELA DE CLIENTE] ([CPF], [NOME], [RUA], [COMPLEMENTO], [BAIRRO], [ESTADO], [CEP], [DATA DE NASCIMENTO],
                                 [IDADE], [SEXO], [LIMITE DE CREDITO], [PRIMEIRA COMPRA])
VALUES ('12345678901', 'João da Silva', 'Rua das Flores', 'Apt 302', 'Centro', 'SP', '12345678', '1990-05-15', 32, 'M',
        5000.00, 1),
       ('98765432101', 'Maria Santos', 'Av. Principal', 'Casa 10', 'Jardim Botânico', 'RJ', '98765432', '1985-12-20',
        37, 'F', 6000.00, 1),
       ('11122233344', 'Carlos Souza', 'Rua do Comércio', 'Sala 5', 'Centro', 'MG', '11122233', '1982-03-10', 40, 'M',
        4500.00, 1),
       ('55566677788', 'Ana Ferreira', 'Av. da Praia', 'Casa 3', 'Beira Mar', 'CE', '55566677', '1987-08-25', 35, 'F',
        5500.00, 1),
       ('99900011122', 'Pedro Pereira', 'Rua dos Pinheiros', 'Apt 101', 'Jardim Paulista', 'SP', '99900011',
        '1995-06-03', 28, 'M', 4800.00, 1);
...
INSERT INTO [TABELA DE PRODUTOS] ([CODIGO DE PRODUTO], [NOME DO PRODUTO], [EMBALAGEM], [TAMANHO], [SABOR],
                                  [PRECO DE LISTA])
VALUES ('1042712', 'Linha Citros - 700 ml - Limão', 'Garrafa', '700 ml', 'Limão', 4.90),
...
INSERT INTO [TABELA DE PRODUTOS]
VALUES ('1042712', 'Linha Citros - 700 ml - Limão', 'Garrafa', 'Limão', '700 ml', 4.90),
...
SELECT [NOME] AS 'Cliente', [ESTADO] AS 'UF'
FROM [TABELA DE CLIENTE]
ORDER BY [NOME];
...
SELECT *
FROM [TABELA DE CLIENTE]
WHERE [ESTADO] NOT LIKE 'SP'
  AND [ESTADO] NOT LIKE 'RJ';
